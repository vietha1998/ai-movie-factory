# 살수 612 — 4화 「평양」 대본 v2.2 (TTS-trimmed)
...
> **v2.2 (TTS-trimmed, 2026-09-16):** pass ngân sách TTS (`tools/tts_budget.py`: video8s ≤22 어절 N+thoại, still ≤45, tập ≤115 어절/phút) — cắt gọn narration ở 25 SC, không chạm thoại/SC/thời gian/open loop/quotes/vùng im; v2.1 = coordinator sửa SC_283–284 이틀→며칠 (P-53).
...
N: 여울에서 이 킬로. 갈대 사이의 낮은 섬이었습니다. 92명은 거기 있었습니다. 연기 한 줄이면 삼십만이 돌아볼 것이었습니다.
서아: 식은 밥입니다. 다 드십시오.
...
N: 진흙은 박기철의 생각이었습니다. 요동성에서 그는 기름이 타는 것을 보았습니다. 젖은 진흙은 불화살에도 타지 않았습니다.
...
N: 불이 없으니 약도 찬물로 우렸습니다. 서아는 그것이 약이 되는지 몰랐습니다. 물어볼 사람은 이 노인뿐이었습니다.
...
N: 다음 날 새벽부터 아리는 아낙들과 나갔습니다. 아리의 어머니는 이 강가 마을 사람이었습니다. 아리는 갈대가 어디까지 이어지는지 알았습니다.
마을 아낙: 아가, 고개 숙이고 걸어라.
...
[SOUND] mưa, giấy ướt.
N: 박기철은 숫자를 두 번 말하는 사람이었습니다. 이 섬에서는 한 번만 말했습니다. 소리가 아까웠습니다.
...
[SOUND] mưa, giấy.
N: 포탄 여덟에 박격포 오십. 요동성의 절반도 안 되는 숫자였습니다. 그것으로 삼십만을 상대해야 했습니다.
...
N: 사람을 세는 기계는 만에서 다시 영으로 돌아갔습니다. 백성민은 몇 번 돌렸는지 종이에 적었습니다. 젖은 종이에서 숫자가 번졌습니다.
...
[SOUND] vắt vải, mưa.
N: 한 뼘. 어른 손으로 한 뼘이었습니다. 박기철은 그것을 수첩에 물이라는 항목으로 적었습니다. 기름 밑에, 탄약 밑에.
박기철: 하루에 한 뼘씩 오릅니다.
...
N: 을보는 강가 사람이 아니었습니다. 그러나 대장장이는 물을 알았습니다. 쇠를 식히는 물이었습니다.
...
N: 물이 오르면 여울은 사라집니다. 그러면 삼십만은 돌아갈 길이 없어집니다. 한승우는 그 셈을 하지 않았습니다. 을지문덕은 이미 했습니다.
한승우: 하루에 한 뼘. 적어 둬.
...
[SOUND] thì thầm, mưa.
N: 우리. 아리는 그 말을 먼저 했습니다. 안에 든 것은 그다음이었습니다.
...
N: 부총관 주법상은 뭍의 군대를 기다리자고 했습니다. 옳은 말이었습니다. 옳은 말은 늦게 오는 법이었습니다.
...
N: 그는 성벽 위의 빈자리를 보았습니다. 빈자리는 항복이거나 함정이었습니다. 그는 앞의 것을 골랐습니다.
내호아: 평양은 비었소. 사만이면 남소.
...
N: 사만. 강회에서 데려온 가장 좋은 병사들이었습니다. 내호아는 그들을 성으로 보내고 배는 강에 남겼습니다. 두 번째 실수였습니다. 첫 번째는 주법상이었습니다.
수 장교: 사만, 성으로!
...
[SOUND] kính rít, mưa.
N: 그는 셋을 보았습니다. 셋 뒤에 아흔이 있다는 것은 아직 몰랐습니다.
탁발흠: 셋. 소리 없이.
...
N: 총은 다시 덮였습니다. 밤의 규칙은 지켜졌습니다. 그 값은 달아난 사람 하나였습니다.
백성민: 쏘지 마.
...
N: 그 소식은 이틀 뒤 우중문에게 닿았습니다. 삼십만은 그때 평양에서 삼십 리 떨어진 산기슭에 있었습니다. 다섯 날을 걸어온 길이었습니다.
전령: 장군, 패수에서 온 글입니다.
...
N: 사만 중 수천. 그 숫자가 대쪽에 적혀 있었습니다. 수군은 이제 없는 것과 같았습니다.
우중문: 내호아가 배로 도망쳤다고?
...
N: 빈 절이 열린 날 밤. 고건무는 갑옷을 벗지 않고 내전으로 들어갔습니다. 대왕이 기다리고 있었습니다. 그리고 또 한 사람이 있었습니다.
고구려 장교: 고건무 장군 드십니다.
...
[SOUND] mưa.
N: 그 위로. 을지문덕은 그렇게 말했습니다. 그 아래에 있었다는 말이기도 했습니다.
...
[SOUND] đèn, mưa.
N: 이기는 것은 대장군의 일이었습니다. 이긴 뒤의 일은 왕의 일이었습니다. 왕은 이긴 뒤를 먼저 물었습니다.
...
[SOUND] lụa, mưa nhỏ.
N: 이번 글은 대나무 통에 담겨 오지 않았습니다. 갑옷 속에 넣어 왔습니다. 급한 글이 아니라 무거운 글이었습니다.
...
[SOUND] bùn, lau, mưa.
N: 오태민은 사흘을 참았습니다. 우리 이야기를 들은 뒤로는 하루도 참기 어려웠습니다. 그의 말은 틀리지 않았습니다.
...
[SOUND] mưa, lau.
N: 요동성에서는 아흔넷이었습니다. 지금은 아흔둘이었습니다. 그 둘이 오태민의 새 논거였습니다.
...
[SOUND] mưa.
N: 서아는 편을 들지 않았습니다. 본 것을 말했습니다. 본 것은 편보다 무거웠습니다.
...
N: 넷째 날 오후. 해모루는 답 없이 마을로 돌아갔습니다. 탁발흠은 우리를 갈대밭에서 보이는 강가로 옮겼습니다. 낚시는 계속됐습니다. 이번 미끼는 사람이었습니다.
선비 기병: 여기 놔라. 보이게.
...
N: 요동성에서 그는 기름을 태웠습니다. 여기는 태울 것이 없었습니다. 그래서 몰이를 골랐습니다. 초원에서 늑대를 잡던 방식이었습니다.
...
N: 몰이. 백성민의 아버지도 그렇게 멧돼지를 잡았습니다. 소리로 몰고, 길목에서 잡았습니다. 이번에는 그들이 멧돼지였습니다.
...
N: 여울 어귀. 오백 개의 활이 갈대밭 쪽을 향했습니다. 몰이가 끝나는 자리였습니다. 탁발흠은 갈대를 태우는 대신 나오는 것을 쏘기로 했습니다.
수 장교: 나오면 쏜다. 기다려.
...
N: 그는 아직 침묵을 지키려 했습니다. 을지문덕의 명령이었습니다. 여기 없는 것처럼 있으라는 것이었습니다.
...
N: 스무 발. 남은 오십의 절반에 가까웠습니다. 박기철은 그 숫자를 듣고 눈을 감았습니다.
사수: 여덟… 아홉… 열!
...
[ACTION-VI] Trong lau bờ bắc: 탁발흠 giật kính đêm khỏi mắt — ống kính lóa trắng vì chớp pháo — dụi mắt, nhìn về cửa bãi cạn bằng mắt thường: chỉ còn lửa nhỏ trên nước; quanh hắn, 20 Tiên Ti đứng chết lặng trong nước; xa xa bờ nam, đuốc trại rối loạn, tiếng bò bứt dây vọng qua sông. Cận.
[SOUND] mưa, bò rống xa qua sông, lửa nhỏ.
N: 삼십만의 뒤가 그 소리를 들었습니다. 요동성에서 열 번, 석문령에서 네 번 울린 소리였습니다. 살수에서 두 번. 탁발흠은 셌습니다. 밤눈은 잠시 멀었습니다.
...
N: 그들은 침묵을 잃고 밤을 얻었습니다. 동쪽 고리는 소리 하나에 풀렸습니다. 그 틈으로 삼 킬로 상류의 두 번째 섬으로 갔습니다.
서아: 흔들지 마세요. 천천히.
...
[SOUND] mưa, bùn.
N: 여덟에서 여섯. 두 발의 값은 밤 하나였습니다. 그리고 사람 둘이었습니다.
박기철: 여섯 발. 이게 답니다.
...
N: 박격포는 오십에서 서른. PZF는 아홉에서 여섯. 이 섬에 오면서 준 것은 없고 쓴 것만 있었습니다.
...
N: 간밤에 삼 킬로를 움직였습니다. 평지였습니다. 산길로 센 이십은 이십이었습니다. 적은 쪽으로 세는 사람의 셈이었습니다.
...
N: 배에 박힌 화살은 뽑지 않았습니다. 뽑으면 피가 났고, 두면 열이 났습니다. 항생제는 없었습니다. 남은 것은 모르핀과 시간이었습니다.
서아: 모르핀 하나. 참아요.
...
N: 을보는 거짓말을 하지 않는 노인이었습니다. 쇠에게도, 사람에게도.
...
N: 아침이 되자 탁발흠은 빈 섬을 걸었습니다. 늘 싸움 뒤에 그 자리를 걸었습니다. 요동성에서도, 석문령에서도.
...
N: 아리는 아낙들만 아는 길을 그렸습니다. 길 끝에 적의 물 긷는 자리와 우리가 있었습니다.
...
N: 총을 놓고 가는 것. 백성민에게는 어려운 일이 아니었습니다. 그는 총보다 칼을 먼저 배운 사람이었습니다.
...
[SOUND] giày trên bùn.
N: 그는 셋 중 하나가 되고 싶었습니다. 진흙에 누워 있는 것은 이제 그만이었습니다.
오태민: 제가 가겠습니다.
...
N: 옷은 마을 아낙들의 남편 것이었습니다. 남편들은 요동으로 갔습니다. 옷만 남아 있었습니다.
...
[SOUND] mưa.
N: 해모루는 넉 줄을 다 외웠습니다. 마지막 줄만 소리 내어 읽었습니다. 그 줄이 전부였습니다.
...
N: 비가 그치고 물이 오르면 강은 김을 냈습니다. 을보는 그것을 대장간 물통에서 배웠습니다. 뜨거운 쇠를 담근 물이었습니다.
...
[ACTION-VI] 백성민 thử lưỡi dao găm vào cọng lau — đứt ngọt; đưa hai dao Goguryeo cho hai lính đi cùng (áo vải gai đã mặc), chỉ vào cổ tay mình rồi vào cổ họng — cách dùng.
...
[ACTION-VI] 오태민 trong hố lau ở mép bãi bắc, mũ tháo, kính bảo hộ đẩy lên trán, K3 trước mặt, K6 trên giá ba chân bên cạnh phủ poncho; nhìn vào sương trắng không thấy gì. Cận.
...
N: 사격 금지. 이 섬에서 가장 많이 들은 명령이었습니다. 오늘은 명령이 세 사람의 목숨이었습니다.
...
[SOUND] nước, rổ, thở.
N: 초병은 아낙들만 보았습니다. 엿새째 같은 아낙들이었습니다. 같은 것은 보이지 않는 법이었습니다.

### SC_205 · LOC_007_SALSU (bờ nam, chốt gác Tùy) · 수 초병 · WPN_201 · video8s · 28:28–28:36
[ACTION-VI] Lính gác Tùy ngồi dựa giáo dưới tấm da, mắt nửa nhắm; thấy bóng các bà trong sương, vẫy tay uể oải cho qua, kéo áo che gáy ngủ tiếp.
[SOUND] sương, ngáy, rổ đi qua.
N: 엿새 동안 같은 얼굴이 같은 시간에 지나갔습니다. 초병은 그것을 풍경으로 보았습니다. 풍경은 검사하지 않는 법이었습니다.
수 초병: 가라, 가.
...
N: 개는 사람보다 먼저 깼습니다. 코가 먼저였고, 귀가 그다음이었습니다.
...
N: 밤을 낮으로 만드는 눈은 낮을 견디지 못했습니다. 안개와 새벽빛이 그 안을 하얗게 채웠습니다. 석문령의 전리품이 처음으로 쓸모없어졌습니다.
...
N: 북쪽 여울에서는 아무것도 보이지 않았습니다. 오태민은 소리로 싸움을 읽었습니다. 개, 나각, 그리고 물.
...
[SOUND] thở, lau.
N: 드론. 그가 잃은 것은 그것이었습니다. 그는 자신을 잃은 것으로 세지 않았습니다.
장태오: 죄송합니다… 드론을…
...
[SOUND] cát đổ, mưa, im.
N: 갈대 사이에 묻었습니다. 석문령에서 하나, 여기서 둘. 천사백 년 뒤의 사람들을 이 땅의 사람들이 함께 덮었습니다.
...
N: 빈 철모는 한승우가 석문령에서 가지고 왔습니다. 해모루가 먼저 육백십이 년의 쇠를 씌웠습니다. 태오는 벗지 않았습니다.
...
[SOUND] sông.
N: 시험에서는 이 뜻을 쓰면 점수를 받았습니다. 여기서는 점수가 없었습니다.
...
[SOUND] mưa.
N: 그는 위치를 팔았습니다. 그것이 그가 가진 유일한 값이었습니다. 우중문은 그 값을 알았습니다.
...
[SOUND] lụa, mưa nhỏ.
N: 왕의 글은 닷새째 그의 가슴에 있었습니다. 누구의 군대인가. 그는 이 강가에 두 사람을 묻었습니다. 그들은 누구의 군대로 묻혔는지 그도 몰랐습니다.
...
## [Phần 12] 물은 오르고, 포탄은 여섯 발 — 「물은 오르고, 포탄은 여섯 발」 / Lịch sử rẽ hướng  (37:30–40:00)
> Tóm tắt VI: Aerial: 방진 khổng lồ bò về bắc trong mưa; kỵ Goguryeo bám bốn mặt [史]; trong vuông: người kiệt sức, xe bỏ. 을지문덕 trên gò với 해모루 nhìn xuống — không nói; quay ngựa về bắc; narrator: "역사는 이 강을 살수라 부릅니다." Aerial 살수: nước cao hơn, mô cát hẹp lại. 박기철 cắm que: "어제보다 한 뼘." 을보 không nói. K2 mô bùn, màn hình "잔탄 06". 오태민 đứng một mình ở bãi bắc nhìn sông; 한승우 phía sau không tới gần. 태오 mũ sắt bên radio, 아리 cạnh. Aerial: đầu 방진 chạm đồi bắc, sông là vệt bạc phía trước. 탁발흠 dẫn đầu. Mưa dày trên mặt sông. Open loop tập. End card.
> Chức năng: OPEN · Tài nguyên: nước +1 gang/ngày · "여섯" · Open loop tập: "30만이 살수로 돌아오고 있었습니다. 물은 오르고, 포탄은 여섯 발이었습니다."
> Anti-copy: không kết bằng "2 chỉ huy trên tường → lều địch → card"; kết bằng que nước + một người đứng một mình ở bãi cạn + mưa trên sông.

### SC_271 · LOC_008_GOGURYEO_VILLAGE (aerial cao, 방진 về bắc) · lính Tùy · WPN_201, PROP_021 · still_kenburns · 37:30–37:40
[ACTION-VI] Ảnh aerial rất cao trong mưa: một hình vuông tối khổng lồ — hàng vạn người — bò qua đồi xanh về phía bắc trên đường lầy, cạnh vuông méo ở góc; quanh nó, những vệt nhỏ hơn (kỵ Goguryeo) bám bốn mặt như chó săn quanh bò. Ken-burns kéo ra tới chân trời bắc.
[SOUND] trống Tùy chậm rất xa, mưa, gió trên cao.
N: 삼십만이 돌아섰습니다. 평양에서 삼십 리, 손가락 한 마디 앞에서. 왔던 길이 돌아가는 길이 되었습니다. 그 길 끝에 강이 있었습니다.

### SC_272 · LOC_008_GOGURYEO_VILLAGE (sườn 방진) · kỵ Goguryeo, lính Tùy · VEH_101, WPN_101 · video8s · 37:40–37:48
[ACTION-VI] Kỵ Goguryeo lao xuống bắn một loạt vào cạnh vuông, quay ngựa vòng đi trước khi nỏ Tùy kịp giương; vài khiên Tùy đổ, cạnh vuông khép lại; cứ thế. Wide, mưa.
[SOUND] dây cung, nỏ Tùy muộn, hô, mưa.
N: 을지문덕은 사방에서 쳤습니다. 삼국사기는 이렇게 적었습니다. 싸우면서 갔다고. 그 문장 안에 며칠이 들어 있었습니다.

### SC_273 · LOC_008_GOGURYEO_VILLAGE (trong 방진) · lính Tùy · WPN_201 · video8s · 37:48–37:56
[ACTION-VI] Trong vuông: lính Tùy lê giáo, một xe bò gãy trục bị bỏ lại giữa đường, người sau vòng qua; mưa xối. Tracking ngược chiều đoàn.
...
N: 한 뼘. 어제도 한 뼘이었습니다. 박기철은 두 눈금 사이를 손으로 쟀습니다. 손은 자보다 정확하지 않았지만 매일 같았습니다.
박기철: 어제보다 한 뼘.

### SC_278 · LOC_007_SALSU (bờ bãi bắc, cạnh cọc) · CHAR_106 · — · video8s · 38:32–38:40
[ACTION-VI] 을보 ngồi xổm trên bờ sau lưng 박기철, bàn tay thọc xuống nước, nheo mắt trái nhìn thượng nguồn — mây đen đè núi; không nói gì; rút tay lên vẩy. Cận.
[SOUND] nước qua tay, sấm xa.
N: 을보는 말하지 않았습니다. 사흘이라는 말은 이미 했습니다. 두 번 말하는 것은 대장장이의 법이 아니었습니다.

### SC_279 · LOC_007_SALSU (đảo lau 2, K2) · — · VEH_001 · still_kenburns · 38:40–38:50
[ACTION-VI] Ảnh: mô bùn K2 dưới lau trong mưa — chỉ nhận ra nòng pháo bọc lau và một góc váy xích; qua cửa tháp hé, ánh xanh lạnh của màn hình trưởng xe với "잔탄 06". Ken-burns đẩy chậm vào khe sáng.
[SOUND] mưa trên bùn, quạt điện tử rất nhỏ.
N: 여섯. 전차는 그 숫자를 매일 밤 켜 두었습니다. 요동성에서 스물둘이었습니다. 살수에서 여섯이었습니다. 다음은 없었습니다.

### SC_280 · LOC_007_SALSU (bãi bắc, mép nước) · CHAR_002 · WPN_003 · video8s · 38:50–38:58
[ACTION-VI] 오태민 đứng một mình ở mép bãi bắc trong mưa, mũ tháo, K3 của người chết đeo chéo lưng, kính bảo hộ trên trán đọng nước, nhìn sang bờ nam qua sông đang dâng; không động. Wide, người nhỏ giữa nước và lau.
[SOUND] mưa, sông.
N: 오태민은 북쪽 여울에 서 있었습니다. 한승우가 준 자리였습니다. 그는 그 자리가 무엇을 위한 자리인지 이제 알았습니다.

### SC_281 · LOC_007_SALSU (bãi bắc, phía sau) · CHAR_001 · PROP_013 · video8s · 38:58–39:06
[ACTION-VI] 한승우 đứng cách 오태민 30 m phía sau, trong mép lau, không tiến tới; tay chạm túi ngực có lụa và mũi tên; nhìn lưng 오태민 rồi nhìn sông. Máy từ sau lưng 한승우 lấy cả hai.
[SOUND] mưa, lau.
N: 두 사람은 같은 강을 보았습니다. 서로 다른 것을 보았습니다. 한 사람은 태오를, 한 사람은 왕의 물음을. 강은 둘 다 상관하지 않았습니다.
...
N: 물은 매일 올랐습니다. 아무도 그것을 막지 않았습니다. 막을 필요가 없었습니다.

### SC_286 · LOC_007_SALSU (aerial bãi bắc, hoàng hôn) · — · VEH_001 (mô bùn) · still_kenburns · 39:42–39:52
[ACTION-VI] Ảnh aerial hoàng hôn mưa: bãi bắc — lau ngập nửa, mô bùn K2 mờ, những chấm người nhỏ trong lau, cọc gỗ trong nước; phía nam, đồi tối; sông là một tấm bạc xám nổi sóng. Ken-burns kéo ra rất chậm.
[SOUND] mưa, sông, gió.
N: 30만이 살수로 돌아오고 있었습니다. 물은 오르고, 포탄은 여섯 발이었습니다.

### SC_287 · [END CARD] · — · — · still_kenburns · 39:52–40:00
[ACTION-VI] Đen. Chữ trắng giữa khung: 「살수 612 · 5화 살수 (最終話)」. Không hình khác.
...
11. **Bài thơ trên màn hình:** SC_176 우중문 đọc âm Hán 2 câu đầu; SC_177–178 still lụa + EDIT overlay chữ Hán nguyên văn + phụ đề Hàn (decisions #6); narrator đọc dịch Hàn đúng outline. Thêm câu N "이 땅에 남은 가장 오래된 시였습니다" (여수장우중문시 = 한시 cổ nhất còn lại — mềm, có thể bỏ).
12. **태오 giải nghĩa thơ cho 아리** (SC_256–258) — trả "나중에 알게 돼" của 3화 P2; 아리 hỏi "그만둘까요?" → 태오 không trả lời, cầm radio (nối "역사가 이미 이겼다").
13. **해모루 đội mũ trụ Goguryeo cho 태오 ở 4화 P11** (SC_255) thay vì chỉ xuất hiện ở 5화 (§8b) — để 5화 P2 mở với mũ đã quen mắt; thoại "머리는 쇠로 덮는 법이오. 어느 해 것이든."
14. **Lệnh 을지문덕 P9(c)** truyền bằng VO trên still (SC_194) + 해모루 nhắc câu cuối (SC_195) — ông không ở đảo lau; quote #5 giữ nguyên văn.
15. **통역 Goguryeo bị bắt** (SC_128, 1 câu) — theo P-11; 태오 chỉ nói "모릅니다" (character_bible).
16. **"살아 있어야 해" (3화)** trả bằng N SC_248 + "살아 있잖아"; 오태민 nhận K3 của người chết 3화 (SC_136, 139, 280).
...
|---|---|---|---|---|
| 1 | Giây đầu có nguy hiểm/câu hỏi | ≤ 0:10 | **0:03** — móng ngựa Tùy dẫm cách mặt 30 cm (SC_001b); 0:16 lính Tùy tiểu cách 백성민 2 m | ✅ |
...
2. 박기철: **"드론, 영. …우린 이제 장님입니다."** / "Drone: không. …Giờ chúng ta mù rồi." (SC_038)
3. 을보: **"이 강은 한 번 화나면 사흘 만에 어른 키를 넘소."** / "Con sông này nổi giận thì ba ngày là quá đầu người lớn." (SC_044)
4. 백성민: **"야시경입니다. 우리 겁니다."** / "Kính nhìn đêm. Của chúng ta." (SC_073)
5. 고건무: **"평양은 고구려 사람이 지키오."** / "Bình Nhưỡng do người Goguryeo giữ." (SC_092)
6. 영양왕 / 해모루 đọc: **"그 뒤에 그대들은 누구의 군대인가?"** / "Sau đó, các ngươi là quân đội của ai?" (SC_114)
7. 오태민: **"태오는 저기 우리에 있고, 우리는 진흙에 누워 있습니다."** / "태오 ở trong cũi bên kia, còn ta nằm trong bùn." (SC_118)
8. 탁발흠: **"젖은 갈대는 안 탄다. 그럼 몰아낸다. 짐승처럼."** / "Lau ướt không cháy. Vậy thì lùa. Như lùa thú." (SC_129)
9. 을지문덕: **"좋소. 서두르게 하시오."** / "Tốt. Cứ để chúng vội." (SC_151)
10. 박기철: **"여섯 발. 이게 답니다."** / "Sáu viên. Chỉ có thế." (SC_154)
11. 탁발흠: **"천둥도 센다. 언젠가는 마른다."** / "Sấm cũng đếm được. Rồi sẽ có lúc cạn." (SC_161)
12. 한승우: **"쏠 순 없어도 보낼 순 있다."** / "Không bắn được, nhưng gửi người được." (SC_166)
13. 을지문덕: **"반이 건널 때까지 아무것도 하지 마시오."** / "Cho đến khi một nửa qua sông, đừng làm gì cả." (SC_194–195)
14. 탁발흠: **"안개엔 눈이 없다. 귀로 잡는다."** / "Trong sương không có mắt. Bắt bằng tai." (SC_218)
15. 한승우: **"살아 있잖아."** / "Còn sống mà." (SC_248)
16. N: **"물은 오르고, 포탄은 여섯 발이었습니다."** / "Nước dâng, và đạn pháo còn sáu viên." (SC_286)
