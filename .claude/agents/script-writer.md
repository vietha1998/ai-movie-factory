...
ĐỊNH DẠNG: header (kèm **bảng ngày/đêm**: ngày N / sáng-trưa-đêm / SC từ–đến / sự kiện sử [史] cùng ngày — mọi câu "X일째/이틀 뒤" phải khớp bảng) · quy tắc 시호: người đương thời không gọi vua bằng tên thụy (영양왕) — dùng 대왕/전하/재위 N년; narrator được dùng 시호 · mỗi phần "## [Phần X] tên KO / VI (phút)" + tóm tắt VI · mỗi cảnh "### SC_nnn · LOC · CHAR · VEH · video8s|still_kenburns · t1–t2" + [ACTION-VI] + [SOUND] + "N:" (KO) + "TÊN: thoại" (KO) · [Kết thúc Phần X]. Ghi file theo từng phần (append), không ghi một lần. Cuối file: bảng thống kê tự đếm (SC, video/still, giây, câu thoại, 어절 narration, câu vi phạm). Copy sang output/epN/kich_ban/full_script.md.
